...
export async function DELETE(request: Request) {
  try {
    ...
    // Delete the priority document for the user and date
    await Priority.findOneAndDelete({ userId, date });

    return NextResponse.json({ message: 'Priorities deleted' }, { status: 200 });
  } catch (error) {
